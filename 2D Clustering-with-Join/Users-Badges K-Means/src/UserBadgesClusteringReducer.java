...
public class UserBadgesClusteringReducer extends Reducer<DoubleDoublePair, DoubleDoublePair, DoubleDoublePair, NullWritable> {

    public void reduce(DoubleDoublePair centroid,
                       Iterable<DoubleDoublePair> data, Context context)
												throws IOException, InterruptedException {
       double sumX = 0;   //Sum of X axis of all UserAge/Badges for the particular cluster.
       double sumY = 0;   //Sum of Y axis or all UserAge/Badges for the particular cluster.
